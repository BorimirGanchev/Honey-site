    ...
    <div className='flex md:flex-row flex-col overflow-auto w-full items-center h-screen mx-auto justify-between'>
      <div className='basis-1/2 h-full'>
        <div className='relative flex flex-col gap-10 top-20 lg:left-40 md:left-56 left-24 '>
          ...
          <div>
            <p className='border-b-2 border-secondary w-1/2 sm:w-1/2 lg:w-1/2 relative top-10' >All our honey is single origin and we are proud practice sustainable beekeeping. Our honey is raw honey that is pure, unpesteurised, unprocessed and with no additives.</p>
          </div>
