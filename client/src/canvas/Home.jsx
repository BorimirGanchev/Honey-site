  ...
  return (
    <div className='flex md:flex-row flex-col w-full items-center h-screen mx-auto justify-between'>
      <div className='basis-1/2 h-full'>
        <div className='relative flex flex-col gap-10 top-20 left-40'>
          ...
          <div className='relative'>
            ...
            <h1 className='text-5xl font-bold text-tertiary relative top-5 left-20' >Good Honey</h1>
          </div>
          <div>
            <p className='border-b-2 border-secondary w-1/2 relative top-10' >All our honey is single origin and we are proud practice sustainable beekeeping. Our honey is raw honey that is pure, unpesteurised, unprocessed and with no additives.</p>
          </div>
          ...
          <div className='relative top-32'>
            <a href="#about">
              ...
              bg-secondary w-1/6 h-10 rounded-md shadow-lg
